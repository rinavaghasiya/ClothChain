                            ...
                            <div class="user-panel-sidebar">
                                <div class="collapse-box">
                                    <h5 class="collapse-title no-border"> My Classified <a class="pull-right"
                                     aria-expanded="true" data-toggle="collapse" href="#MyClassified"><i
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                        <strong><li class="active nav-item"><a  class="nav-link" href="{{ url('accountmessagebinbox') }}"> Inbox
                                            ...
                                            <div class="list-group">
                                             <form role="form" action="" method="get" enctype="multipart/form-data">
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="{{ url('accountmessagebdetail') }}/{{$msg->id}}" class="list-box-user">
                                                    ...
                                                    <br>
                                                    <a href="{{ url('accountmessagebdetail') }}/{{$msg->id}}" class="list-box-content"><br>
