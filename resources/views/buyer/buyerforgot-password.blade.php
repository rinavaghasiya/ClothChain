                ...
                <div class="col-sm-5 login-box">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                             @if(Session::has('message'))
                              ...
                              @endif
                            <form role="form" action="{{url('buyerresendmail')}}" method="post">
                                  {{ csrf_field() }}
                        ...
                        <div class="card-footer">
                            <p class="text-center "><a href="{{ url('buyerlogin') }}"> Back to Login </a></p>
                    ...
                    <div class="login-box-btm text-center">
                        <p> Don't have an account? <br>
                            <a href="{{ url('buyersignup') }}"><strong>Sign Up !</strong> </a></p>
                    </div>
                </div>
            </div>
        </div>
