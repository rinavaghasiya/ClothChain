                                ...
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                      ...
                                      <li class="nav-item"><a  class="nav-link" href="{{ url('buyerfavourite') }}">Starred</a>
                                         ...
                                         <strong> <li class="nav-item"><a  class="nav-link" href="{{ url('buyerimportant') }}">Important</a></strong>
                                        </li>
                                    ...
                                    <div class="message-list">
                                        <div id="home">
                                            ...
                                            <div class="list-group">
                                                    ...
                                                    @foreach($data as $msg)
                                                    @if($msg->buyerread_status == '0' && $msg->buyerimportant_status == "Important" )
                                                  <div class="list-group-item">    
                                                    ...
                                                    <div class="list-box-action">
                                                        ...
                                                        <a href="{{ url('buyerfavouritemail') }}/{{$msg->id}}" data-toggle="tooltip" data-placement="top" class="markAsStar" id="favorite" name="favorite" value="" 
                                                           title="Mark as Favourite "><i class="fas fa-star"></i></a>
                                                        @else
                                                            <a href="{{ url('buyerfavouritemail') }}/{{$msg->id}}" data-toggle="tooltip" data-placement="top" class="markAsStar" id="snull" name="snull" value="Favourite"
                                                        ...
                                                        <a href="{{ url('buyernotimportantemail') }}/{{$msg->id}}"  class="markAsCircle" data-toggle="tooltip" data-placement="top"
                                                           title="Mark as Important "> <i class="fas fa-circle"></i></a>
                                                           @endif
                                                    </div>
                                                </div>
                                                @elseif($msg->buyerread_status == '1' && $msg->buyerimportant_status == "Important")
                                                <div class="list-group-item">
                                                  <a href="{{ url('buyermessagedetail') }}/{{$msg->id}}" class="list-box-user">
                                                        ...
                                                        @else
                                                         @php $a = explode(",",$msg->seller1_img); @endphp
                                                             <img class="thumbnail no-margin" src="{{ url('public/image') }}/{{ $msg->seller2_img }}" alt="img" height="30px" width="30px">
