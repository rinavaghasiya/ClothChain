                                ...
                                <div class="collapse-box">
                                 ...
                                 <div class="collapse-box">
                                    <h5 class="collapse-title"> Terminate Account
                                        <a class="pull-right" aria-expanded="true" data-toggle="collapse" href="#TerminateAccount"><i class="fa fa-angle-down"></i></a></h5>
                                ...
                                <div class="col-md-9 col-lg-10 chat-row">
                                    ...
                                    <div class="message-chat">
                                        <div class="message-chat-history">
                                             ...
                                             @foreach($data as $msg) 
                                            <strong>{{$msg->bfname}} {{$msg->blname}}</strong>
                                        ...
                                        <div class="type-message" id="reply" style="display: none;">
                                            ...
                                            <div class="type-form" >
                                                 ...
                                                 <input type="hidden" name="receiver_id" class="form-control"  value="{{$msg->bemail}}">
