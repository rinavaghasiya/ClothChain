...
@endsection
@section('content')
<div class="search-row-wrapper" style="background-image: url(public/images/bg3.jpg)">
                        ...
                        <div class="sidebar-modern-inner">
                            ...
                            <div class="block-content categories-list  list-filter ">
                                <ul class=" list-unstyled">
                                    @foreach($cat as $ct)
                                    <li><a  href="{{ url('subcategory') }}/{{$ct->c_name}}"><span class="title">{{$ct->c_name}}</span><span class="count">&nbsp;</span></a>
                                    </li>
                                    @endforeach
                          ...
                          <div class="block-content locations-list  list-filter ">
                                <ul class="browse-list list-unstyled long-list">
                                    @foreach($state as $st)
                                    <li><a href="{{ url('substate') }}/{{$st->StateName}}"> {{$st->StateName}} </a></li>
                                    @endforeach
                                   </ul>
                            </div>
                           <div class="block-title has-arrow">
                            ...
                            <div class="block-content categories-list  list-filter " id="search">             
                                <form role="form"  action = "" method="get" class="form-inline ">
                                   
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" value="{{ Request::get('min') }}"  name="min" placeholder="Min Rs." id="minPrice" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-1 col-md-12 no-padding text-center hidden-md"> -</div>
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" value="{{ Request::get('max') }}"  name="max"  placeholder="Max Rs." id="maxPrice"  class="form-control">
                                    </div>
                        ...
                        <div class="tab-box ">
                         <ul class="nav nav-tabs add-tabs tablist" role="tablist">
                                <li class="active nav-item">
                                    <a href="" role="tab" data-toggle="tab" class="nav-link active" id="all">All Ads <span class="badge badge-pill badge-secondary">{{count($call)}}</span></a>
                                </li>
                                <li class="nav-item">
