        ...
        <div class="container">
            <div class="row">
                    ...
                    <aside>
                        <div class="inner-box">
                            <div class="user-panel-sidebar">
                                ...
                                <div class="collapse-box">
                                    <h5 class="collapse-title"> My Ads <a class="pull-right" aria-expanded="true"  data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a> </h5>
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse show">
                                        <ul class="acc-list">
                                            ...
                                            <li class="active"><a href="{{ url('decline') }}"><i class="fa fa-ban" aria-hidden="true"></i> Decline Product <span
                                 ...
                                 <div class="collapse-box">
                                    <h5 class="collapse-title"> Terminate Account <a class="pull-right" aria-expanded="true"  data-toggle="collapse" href="#TerminateAccount">
                ...
                <div class="col-md-9 page-content">
                    <div class="inner-box">
                        <h2 class="title-2"><i class="fa fa-ban" aria-hidden="true"></i> Decline Product </h2>
                        <div class="table-responsive">
                            <div class="table-action">
                                <div class="table-search pull-right col-sm-7">
                                    <div class="form-group">
                                         <form class="form-horizontal"  action = "{{ url('decline') }}" >
                                        <div class="row">
                                            {{ csrf_field() }}
                                  ...
                                  @php $a = explode(",",$image->image); @endphp
                                   ...
                                   <td style="width:14%" class="add-img-td"> <strong>Rs.</strong>{{$image->price}}</td>
                                    ...
                                    <td style="width:10%" class="action-td">
                                        <div>
                                            <a href ='updateproduct/{{ $image->p_id }}'><button type="submit" class="btn btn-primary">Edit</button></a>
