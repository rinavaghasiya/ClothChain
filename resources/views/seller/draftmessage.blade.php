                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                        ...
                                        <strong><li class="nav-item"><a  class="nav-link" href="{{ url('draftmessage') }}">Drafts <span
                                        ...
                                        <div id="home">
                                            ...
                                            <div class="list-group">
                                                  ...
                                                  <div class="list-group-item">    
                                                        <a href="{{ url('draftseller') }}/{{$msg->id}}" class="list-box-user">
                                                    ...
                                                    <br>
                                                    <a href="{{ url('draftseller') }}/{{$msg->id}}" class="list-box-content">
                                                        <br>
