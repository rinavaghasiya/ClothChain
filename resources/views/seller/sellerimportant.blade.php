                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                        ...
                                        <li class="active nav-item"><a  class="nav-link" href="{{ url('favourite') }}">Starred</a>
                                        </li>
                                    
                                        <strong><li class="nav-item"><a  class="nav-link" href="{{ url('important') }}">Important</a>
                                        </li></strong>
                                    ...
                                    <div class="message-list">
                                        <div id="home">
                                            ...
                                            <div class="list-group">
                                                    ...
                                                    @foreach($data as $msg)
                                                    @if($msg->sellerread_status == '0' && $msg->sellerimportant_status == "Important"  )
                                                  <div class="list-group-item">    
                                                    ...
                                                    <div class="list-box-action">
                                                        ...
                                                        <a href="{{ url('notimportantemail') }}/{{$msg->id}}"  class="markAsCircle" data-toggle="tooltip" data-placement="top"
                                                           title="Mark as Important "> <i class="fas fa-circle"></i></a>
                                                           @endif
                                                    </div>
                                                </div>
                                                @elseif($msg->sellerread_status == '1' && $msg->sellerimportant_status == "Important")
                                                <div class="list-group-item">
                                                    <a href="{{ url('sellermessagedetail') }}/{{$msg->id}}" class="list-box-user">
