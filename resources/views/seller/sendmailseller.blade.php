                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                        ...
                                        <strong><li class="nav-item"><a  class="nav-link" href="{{ url('sendmailseller') }}">Sent
                                            Mail</a>
                                        </li></strong>
                                            ...
                                            <div class="list-group">
                                                  ...
                                                  <div class="list-group-item">    
                                                    ...
                                                    <div class="list-box-action">
                                                        ...
                                                        <a href="{{ url('favouritemail') }}/{{$msg->id}}" data-toggle="tooltip" data-placement="top" class="markAsStar" 
                                                            value="" 
                                                           title="Mark as Favourite "><i class="fas fa-star"></i></a>
                                                        @else
                                                            <a href="{{ url('favouritemail') }}/{{$msg->id}}" data-toggle="tooltip" data-placement="top" class="markAsStar"  value="Favourite"
