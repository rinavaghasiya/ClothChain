                            ...
                            <div class="block-content categories-list  list-filter " id="search">             
                                <form role="form"  action = "" method="get" class="form-inline ">
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" id="min" name="min" value="{{ Request::get('min') }}" placeholder="Min Rs. " id="minPrice" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-1 col-md-12 no-padding text-center hidden-md"> -</div>
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" id="max" value="{{ Request::get('max') }}" name="max"  placeholder="Max Rs. " id="maxPrice" class="form-control">
                                    </div>
                    ...
                    <div class="tab-box ">
                        <ul class="nav nav-tabs add-tabs tablist" role="tablist">
                                <li class="active nav-item">
                                    <a href="" role="tab" data-toggle="tab" class="nav-link active" id="all">All Ads <span class="badge badge-pill badge-secondary">{{count($data)}}</span></a>
                                </li>
                                <li class="nav-item">
