Price @extends('layout.seller.content')
@section('title')
WomanCategoty
@endsection
@section('content')
            ...
            <div class="row">
                        ...
                        <div class="sidebar-modern-inner">
                            ...
                            <div class="block-content categories-list  list-filter ">
                                <ul class=" list-unstyled">
                                    @foreach($cat as $ct)
                                    <li><a href="{{ url('womansubcategory') }}/{{$ct->c_name}}"><span class="title">{{$ct->c_name}}</span><span class="count">&nbsp;</span></a>
                                    </li>
                                    @endforeach
                            ...
                            <div class="block-content locations-list  list-filter ">
                                <ul class="browse-list list-unstyled long-list">
                                    @foreach($state as $st)
                                    <li><a href="{{ url('womanstate') }}/{{$st->StateName}}"> {{$st->StateName}} </a></li>
                                    @endforeach
                                     </div>
                         <div class="block-title has-arrow">
                            ...
                            <div class="block-content categories-list  list-filter ">
                               ...
                               <form role="form"  action = "" method="get" class="form-inline ">
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" id="wmin" name="wmin" value="{{ Request::get('wmin') }}" placeholder="Min Rs. " id="minPrice" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-1 col-md-12 no-padding text-center hidden-md"> -</div>
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" id="wmax" value="{{ Request::get('wmax') }}" name="wmax" placeholder="Max Rs. " id="maxPrice" class="form-control">
                                    </div>
                ...
                <div class="col-md-9 page-content col-thin-left">
                    ...
                    <div class="category-list ">
                        <div class="tab-box ">
                             <ul class="nav nav-tabs add-tabs tablist" role="tablist">
                                ...
                                <li class=" nav-item">
                                    <a href="{{ url('men') }}"  id="men"> Men <span class="badge badge-pill badge-secondary">{{count($cmen)}}</span></a>
                                </li>
                                <li class=" active nav-item">
                                    <a href="active{{ url('woman') }}" data-toggle="tab" class="nav-link active"  id="woman"> Woman <span class="badge badge-pill badge-secondary">{{count($woman)}}</span></a>
                                </li>
                            </ul>
                            <form action="" method="get">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="item-list">
                                ...
                                <div class="row" id="woman_row" >
                                      @foreach($woman as $image) 
                         ...
                         <span class="info-row">
                            ...
                            <span class="item-location"><i class="fa fa-map-marker-alt"></i> {{$image->StateName}}</span>
                            </span>
                            </div>
                            </div>
                    ...
                    @endforeach
                     ...
                     <div class="pagination-bar text-center" id="woman1" >
                        <nav aria-label="Page navigation " class="d-inline-b">
                            <ul class="pagination">
                             <li class="page-item active">{{$woman->appends(\Request::except('_token'))->render() }}</li></li>
                              </ul>
                        </nav>
                    </div>
